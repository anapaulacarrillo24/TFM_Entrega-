...
Días Estancado: Días sin transferencia logística.
 ROJO (Crítico): Riesgo de fallo inminente (>70%) o vida útil agotada (>100%). Acción: Presupuestar reemplazo.
AMARILLO (Alerta): Activo infrautilizado ("Zombi", >180 días estancado) o inicio de desgaste (>40%). Acción: Revisar o reasignar.
 VERDE (Saludable): Operación normal dentro de los márgenes óptimos de la institución
